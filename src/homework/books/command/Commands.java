...
public interface Commands {
    ...
    static void printUserCommands() {
        ...
        System.out.println("Please, input " + PRINT_BOOKS_BY_PRICE_RANGE + " to show all the books at aa.txt specified price");
    ...
    static void printAdminCommands() {
        ...
        System.out.println("Please, input " + PRINT_AUTHOR_BY_EMAIL + " to show the author by email");
        System.out.println("Please, input " + PRINT_ALL_AUTHORS + " to show all the authors");
        System.out.println("Please, input " + ADD_BOOK + " to add aa.txt book");
